...
impeach %>% 
  ...
  summarise(gdp_above_national = n()) 
...
impeach %>% 
  ...
  summarise(pct_bachelors_compared_to_national = n()) 
...
impeach %>% 
  group_by(for_impeachment) %>% 
  summarise(mean_pct = mean(pct_bachelors))
...
impeach %>% 
  group_by(for_impeachment) %>% 
  summarise(mean_trump_pct = mean(trump_percent))
